...
(function mlInit() {
  ...
  CanvasRenderingContext2D.prototype.mlFillText = function(
    text,
    x,
    y,
    w,
  ...
  CanvasRenderingContext2D.prototype.mlStrokeText = function(
    text,
    x,
    y,
    w,
  ...
  CanvasRenderingContext2D.prototype.mlFillStrokeText = function(
    text,
    x,
    y,
    w,
