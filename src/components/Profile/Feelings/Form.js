                        ...
                        <div className="controls-holder" style={{ padding: '10px 20px' }}>
                          <form>
                            <div class="form-group">
                              <div className="row">
                                ...
                                <div className="col">
                                  ...
                                  <select class="form-control" id="fontWeight" onChange={this.handleControlsChange} value={this.state.fontWeight}>
                            ...
                            <div class="form-group">
                              <div className="row">
                                ...
                                <div className="col">
                                  ...
                                  <select class="form-control" id="textAlign" onChange={this.handleControlsChange} value={this.state.textAlign}>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" id="fontFamily" onChange={this.handleControlsChange} value={this.state.fontFamily}>
