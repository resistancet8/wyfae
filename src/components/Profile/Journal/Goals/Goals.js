      ...
      return (
        <div className='bg-secondary p-2 mb-1 rounded todo-item' key={index}>
          ...
          <div className='d-flex'>
            <button className='remove-goals-btn' color='secondary' onClick={event => this.props.deleteGoals(index)}>
              Remove
            </button>
            <small className='font-italic ml-auto mr-1 p-0 m-0'>By: {goal.date}</small>
          </div>
        </div>
      )
    })
