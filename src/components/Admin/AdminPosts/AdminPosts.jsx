...
class Adminpost extends Component {
  ...
  loadFunc() {
    ...
    axios
      .post(`${process.env.REACT_APP_API_ENDPOINT}/dashboard/get_post`, { skip_count: this.state.inview.length, limit_count: 10 }, axiosConfig)
      .then(response => {
  ...
  componentDidMount() {
    ...
    axios
      .post(`${process.env.REACT_APP_API_ENDPOINT}/dashboard/get_post`, { skip_count: 0,  limit_count: 5 }, axiosConfig)
      .then(response => {
        let data = response.data.all_content;
  ...
  render() {
    let items = this.state.inview.map((post, index) => {
      return <Row className="my-4 border-bottom">
        ...
        <Col md="4"><div className="text-capitalize">{post.post_title.substr(0, 30)}</div></Col>
        ...
        <Col md="1">
          <Link to={`/admin/dashboard/posts/view/${post._id}`}><button title="view" class="btn"><i class="fa fa-eye"></i></button></Link>
    ...
    return (
      <div className="pr-2">
        ...
        <Row className="border py-3">
          ...
          <Col md="1"> <strong>Art Type</strong></Col>
          <Col md="1"> <strong>Comments</strong></Col>
          <Col md="1"> <strong>Likes</strong></Col>
          <Col md="1"> <strong>Shared Type</strong></Col>
